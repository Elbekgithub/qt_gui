...
class QImageViewer(QMainWindow):
    ...
    def __init__(self):
        ...
        self.firmLable.setStyleSheet('font-size: 24px; color: white; font-family:Times New Roman; font-weight: bold; background-color:#120a36; padding:5px;')

        self.zoneLable = QLabel()
        self.zoneLable.setText("ZONE: Rezka")
        self.zoneLable.setStyleSheet('color: white; font-family:Times New Roman;  background-color:#120a36; padding:5px;')

        self.panelLabel = QLabel()
        self.panelLabel.setText("L1-01")
        self.panelLabel.setStyleSheet('color: white; font-family:Times New Roman;  background-color:#120a36; padding:5px;')

        self.errorlabel = QLabel()
        self.errorlabel.setText("Error:")
        self.errorlabel.setAlignment(Qt.AlignTop)
        self.errorlabel.setStyleSheet('font-size: 18px; color: red; font-family:Times New Roman;background-color:#120a36')
    ...
    def starter(self):
        ...
        try:
            ...
            self.errorlabel.setText(f"Serverga bog'lanishda xatolik!, Serveriga bog'lana olmadi. Xatolik sababi:TimeOutError")
        ...
        if len(self.lineEdit.text()) > 0:
            if not self.lineEdit.text() in self.memory:
                ...
                if self.counter < min(self.comth):
                    ...
                    self.combo.clear()  
                    if self.counter %2 == 0:
                        self.combo.addItems(list(map(str, self.comth[self.comth.index(self.counter)+1:])))
